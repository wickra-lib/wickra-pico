...
<!--
What are you trying to do that Wickra Pico doesn't support today?
...
// proposed API
let mut engine = SignalEngine::with_periods(9, 21);
...
or other implementations you'd like Wickra Pico to match.
-->
