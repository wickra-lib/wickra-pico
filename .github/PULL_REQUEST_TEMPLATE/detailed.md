<!--
Thanks for contributing to Wickra Pico!
...
## Numerical correctness (If you touched the kernel)

- [ ] Output matches the std `wickra-core` reference and the golden series (prior Wickra Pico release) within documented tolerance
